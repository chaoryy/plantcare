  ...
  plants: [
    {
      id: "plant_1",
      name: "Монстера",
      next_water: "2026-05-21", // Попадет в список "Сегодня"
      note: "Жарко, поливать чаще",
    },
    {
      id: "plant_2",
      name: "Кактус",
      next_water: "2026-05-22", // Попадет в "Ближайшие" (отобразится как "22 мая")
    },
    {
      id: "plant_3",
      name: "Фикус",
      next_water: "2026-05-20", // Прошедшая дата (пропадет из обоих списков)
      note: "Проверить на клеща",
    },
  ],
};
